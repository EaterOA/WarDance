...
private:
	...
	void affixPos(sf::Vertex sprite[4], const sf::Vector2f &center);
	void affixPos(sf::Vertex sprite[4], const sf::Vector2f &center, float offsetLY, float offsetRY, float offsetLX, float offsetRX);
