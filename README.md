...
A 32-bit Windows executable version of WarDance (built on 3/02/14) is available in this root git directory. To run it, simply make sure config, fonts, and images are all present.
