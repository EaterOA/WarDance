...
A 32-bit Windows executable version of WarDance (built on 2/3/14) is available in this root git directory. To run it, simply make sure config, fonts, and images are all present.
